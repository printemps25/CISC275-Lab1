...
const yourName : String = "Karen (Kay) Sousa";
let yourPronouns : String = "She/Her";
const yourMajor : String = "Computer Science";
let classification : String = "Junior";
let oneExcite : String = "I am excited to learn more about HTML and CSS.";
let anyConcerns : String = "I am a bit worried about the pagitce.";
